...
# source: sequence_annotations.proto
...
_ATTRIBUTES_ATTRIBUTEVALUE.fields_by_name['external_identifier'].message_type = common__pb2._EXTERNALIDENTIFIER
_ATTRIBUTES_ATTRIBUTEVALUE.fields_by_name['ontology_term'].message_type = metadata__pb2._ONTOLOGYTERM
...
_FEATURE.fields_by_name['strand'].enum_type = common__pb2._STRAND
_FEATURE.fields_by_name['feature_type'].message_type = metadata__pb2._ONTOLOGYTERM
...
Attributes = _reflection.GeneratedProtocolMessageType('Attributes', (_message.Message,), dict(
  ...
  AttributeValue = _reflection.GeneratedProtocolMessageType('AttributeValue', (_message.Message,), dict(
    ...
    __module__ = 'sequence_annotations_pb2'
