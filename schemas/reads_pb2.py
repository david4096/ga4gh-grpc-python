...
_READGROUP.fields_by_name['experiment'].message_type = metadata__pb2._EXPERIMENT
...
_LINEARALIGNMENT.fields_by_name['cigar'].message_type = common__pb2._CIGARUNIT
